...
$(document).ready(function() 
{
	...
	(
		{
				title: "",text: "Welcome to The Association. \"tA\" is a Jamaican based Ai collective with the goal to turn Ja in to an Ai ecosystem through education and technology application.\n\nWe consider Ai as \"fabric Neuroverse\" Embodied (Ai Imbued Hardware Niche → such as The Association's self driving car, or drone harvestor) and \"fabric Neuroverse\" Embedded (Ai Software → such as Ai Disease Diagnosis software). ________The space time fabric of Ai, is reasonably malleable; as depicted by the hand containing a cross section of the cosmos!", imageUrl: 'data/images/logoSmall.jpg', html: true, showCancelButton: false,
